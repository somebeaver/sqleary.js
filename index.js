...
export default class Query {
   ...
   *   databse contents. Values can be a string, number, or array. Or, an array
   ...
   *   Can be `=`, `LIKE`, `IN`, 'NOT IN`.Defaults to `=`. When using `LIKE`,
   *   you must put `%` signs around your value.
   *
   ...
   *   the database. This can also be set to the thing "rand" for random order.
   * 
   * - `page`: For pagination. Defaults to page 1.
   * 
